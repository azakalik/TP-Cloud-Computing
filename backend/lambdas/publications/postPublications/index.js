...
exports.handler = async (event) => {
    ...
    try {
        ...
        const { user, initialPrice, dueTime, title, description, image, filename, country = "AR" } = JSON.parse(event.body); // Default country to "AR" if not provided
        ...
        item1 = {
            ...
            Item: {
                ...
                Image: { S: imageUrl },
                Country: { S: country } // Add country field
            }
        };
    } catch (error) {
        console.error(error);
